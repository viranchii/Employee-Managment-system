...
if (strlen($_SESSION['etmsaid'] == 0)) {
    ...
    <head>
        ...
        <title>Employee Management System || View Approved Leaves</title>
                                            ...
                                            <div class="table-responsive-sm">
                                                <table class="table table-bordered">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <?php
                                                        $status = 1;
                                                        $sql = "SELECT tblleaves.*,tblemployee.EmpName from tblleaves join tblemployee on tblemployee.EmpId=tblleaves.empid where tblleaves.Status=:status order by tblleaves.empid desc";
