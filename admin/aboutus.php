...
if ($query->execute()) {
$_SESSION['swal_message'] = "<script>
  document.addEventListener('DOMContentLoaded', function() {
      Swal.fire({
          icon: 'success',
          title: 'Updated Successfully!',
          text: 'The About Us page has been updated.',
...
if(isset($_SESSION['swal_message'])) {
    ...
    unset($_SESSION['swal_message']); // Clear the session message
}
?>
                        ...
                        <fieldset>
                           ...
                           <br>
                            <div class="field">
                              ...
                              <textarea type="text" rows="7" name="pagedes" class="form-control" required='true'><?php  echo $row->PageDescription;?></textarea>
                           </div>
                          <?php $cnt=$cnt+1;}} ?>
