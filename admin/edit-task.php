...
$query->bindParam(':eid',$eid,PDO::PARAM_STR);
 $query->execute();
 $_SESSION['success_msg'] = "Task detail has been updated successfully!";
 header("Location: edit-task.php?editid=$eid"); // Redirect to the same page
 exit();
}
...
<html lang="en">
   <head>
      <title>Employee Management System || Update Task</title>
...
<br>
                            ...
                            <a href="taskfiles/<?php echo htmlentities($row->taskFile);?>" style="color:red" target="blank">View File</a>
                         <?php else: ?>
                           NA
                            <?php endif ?>
