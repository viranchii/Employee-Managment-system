...
<html lang="en">
   <head>
      ...
      <title>Employee Management System || View Inprocess Complaint</title>
                     ...
                     <div class="row column_title">
                        <div class="col-md-12">
                           <div class="page_title">
                              <h2>View Inprocess Complaints</h2>
                           </div>
                        </div>
                     </div>
                     <!-- row -->
                                    ...
                                    <table class="table table-bordered">
                                       ...
                                       <tbody>
                                          ...
                                          <?php
                                             ...
                                             $sql="select tblcomplaints.*,tblemployee.EmpName as name from tblcomplaints join tblemployee on tblemployee.EmpId=tblcomplaints.employeeId where tblcomplaints.status='in process'";
