                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    $sql = "SELECT tblemployee.EmpName, tblsalary.* 
                                                            ...
                                                            WHERE tblsalary.PaymentStatus='pending'";
                                                    $query = $dbh->prepare($sql);
                                                    $query->execute();
...
<?php endif; ?>
                                                                ...
                                                                <td><?php echo htmlentities($row->PaymentDate); ?>Not Paid Yet</td>
                                                                <td>
                                                                        <a href="view-pending-salary.php?payid=<?php echo htmlentities($row->SalaryID); ?>"
