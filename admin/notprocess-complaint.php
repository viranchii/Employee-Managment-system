...
if (strlen($_SESSION['etmsaid'] == 0)) {
   ...
   <head>
      ...
      <title>Employee Management System || View Not process Complaint</title>
                     ...
                     <div class="row column_title">
                        <div class="col-md-12">
                           <div class="page_title">
                              <h2>View Not process Complaints</h2>
                           </div>
                        </div>
                     </div>
                     <!-- row -->
                                 ...
                                 <div class="table-responsive-sm">
                                    <table class="table table-bordered">
                                       ...
                                       <tbody>
                                          ...
                                          $sql = "SELECT tblcomplaints.*, tblemployee.EmpName AS name FROM tblcomplaints JOIN tblemployee ON tblemployee.EmpId = tblcomplaints.employeeId WHERE tblcomplaints.status IS NULL";
                                          ...
                                          if ($query->rowCount() > 0) {
                                             ...
                                             <td><?php  echo htmlentities($row->issuetype);?></td>
                                                   ...
                                                   <td><a href="complaint-details.php?viewid=<?php echo htmlentities($row->complaintNumber); ?>">
