...
$query->execute();
$_SESSION['delete_success'] = "Task has been deleted successfully!";
...
function confirmDelete(taskId) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location.href = "manage-task.php?delid=" + taskId;
        }
    });
}
</script>
...
document.addEventListener("DOMContentLoaded", function() {
    <?php if(isset($_SESSION['delete_success'])) { ?>
        ...
        <?php unset($_SESSION['delete_success']); // Remove the message after displaying ?>
    <?php } ?>
});
</script>
