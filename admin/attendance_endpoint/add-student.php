...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['student_name'], $_POST['course_section'])) {
        ...
        try {
            $stmt = $dbh->prepare("INSERT INTO tbl_student (student_name, course_section, generated_code) VALUES (:student_name, :course_section, :generated_code)");
            ...
            header("Location: http://localhost/ETMS-MAIN/admin/attendance_masterlist.php");
