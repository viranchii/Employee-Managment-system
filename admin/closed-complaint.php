                                    ...
                                    <table class="table table-bordered">
                                       ...
                                       <tbody>
                                          ...
                                          <?php
                                             ...
                                             $sql="select tblcomplaints.*,tblemployee.EmpName as name from tblcomplaints join tblemployee on tblemployee.EmpId=tblcomplaints.employeeId where tblcomplaints.status='closed'";
