             ...
             document.addEventListener('DOMContentLoaded', function() {
                 Swal.fire({
                     ...
                     if (result.isConfirmed) {
                         window.location.href = 'all-task.php';
                     }
                 });
             });
         </script>";
                                 ...
                                 <div class="table-responsive-sm">
                                       ...
                                       foreach ($results as $row) { ?>
                                          <table class="table table-bordered" style="color:#000">
                                             ...
                                             <tr>
                                                ...
                                                <th>Task Priority</th>
                                                <td><?php $priority = $row->TaskPriority;
                                                if ($priority == 'Normal'): ?>
                                                   ...
                                                   <?php elseif ($priority == 'Most Urgent'): ?>
                                                      <span class="badge bg-danger">Most Urgent</span>
                                                   <?php endif; ?>
                                             ...
                                             <tr>
                                                <th>File</th>
                                                <td> <?php if (!empty($row->taskFile)): ?>
                                                      <a href="../admin/taskfiles/<?php echo htmlentities($row->taskFile); ?>"
                                                         style="color:red" target="blank">View File</a>
                                                   <?php else: ?>
                                                      NA
                                                   <?php endif ?>
                                                </td>
                                    ...
                                    if ($status != "") {
                                       ...
                                       <table id="datatable" class="table table-bordered dt-responsive nowrap"
                                          ...
                                          <tr align="center">
                                             <th colspan="5" style="color:#000">Task History</th>
                                          </tr>
                                          <tr>
                                             <th>#</th>
                                             <th>Remark</th>
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                   <span class="skill" style="width:90%;">Task Progress<span
                                                         class="info_valume"><?php echo $row->WorkCompleted; ?>%</span> </span>

                                                   <div class="progress skill-bar ">
                                                      <div class="progress-bar progress-bar-animated progress-bar-striped"
                                                         role="progressbar" aria-valuenow="<?php echo $row->WorkCompleted; ?>"
                                                ...
                                                <table class="table table-bordered table-hover data-tables">
                                                   <form method="post" name="submit">
                                                      <tr>
                                                         ...
                                                         <td>
                                                            <textarea name="remark" placeholder="Remark" rows="12"
                                                               cols="14" class="form-control wd-650"
                                                      ...
                                                      <tr>
                                                         ...
                                                         <td>
                                                            <input name="workcom"
                                                               placeholder="Work Completion in percentage (Eg: 20)"
                                                               pattern="[0-9]+" title="only numbers" rows="12" cols="14"
                                                      ...
                                                      <tr>
                                                         ...
                                                         <td>
                                                            <select name="status" class="form-control wd-450"
                                                               required="true">
                                                               <option value="Inprogress" selected="true">Inprogress
                                                               </option>
