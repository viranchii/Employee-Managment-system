...
<html lang="en">
   <head>
      <title>Employee Management System || Update Employee Profile Pic</title>
                        ...
                        <fieldset>
                         ...
                         <br>
                           <div class="field">
                              ...
                              <img src="../admin/images/<?php echo $row->ProfilePic;?>" width="100" height="100" value="<?php  echo $row->ProfilePic;?>">
                           </div>
