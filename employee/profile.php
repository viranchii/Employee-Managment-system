...
if (strlen($_SESSION['empid'] == 0)) {
   ...
   if (isset($_POST['submit'])) {
      ...
      $empdoj = $_POST['empdoj'];
      $desc = $_POST['desc'];
      $sql = "update tblemployee set EmpName=:empname,Designation=:designation,EmpDateofbirth=:empdob,EmpAddress=:empadd,EmpDateofjoining=:empdoj,Description=:desc where EmpId=:eid";
      ...
      <div class="full_container">
                                                         ...
                                                         <fieldset>
                                                            ...
                                                            <div class="field">
                                                               ...
                                                               <input type="text" name="empcontno"
                                                                  ...
                                                                  class="form-control" readonly='true' maxlength="10"
                                                                  pattern="[0-9]+">
                                                            </div>
                                                            <br>
                                                            <div class="field">
                                                            ...
                                                            <div class="field qrdetails">
                                                               <div><label class="label_field">Employee Pic</label>
                                                                  <img src="../admin/images/<?php echo $row->ProfilePic; ?>"
                                                                     width="100" height="100"
                                                                     value="<?php echo $row->ProfilePic; ?>">
                                                                  <a href="changeimage.php?editid=<?php echo $row->eid; ?>">
                                                                     &nbsp;
                                                                     Edit Image
                                                                  </a>
                                                               </div>

                                                               <div class="qrblock"><label class="label_field">Attendance
                                                                     Qr</label>
                                                                  &ensp;
                                                                  <img class="qrimage"
                                                                     src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=<?= $row->qrcode ?>"
                                                                     alt="" width="100">
                                                               </div>
                                                            </div>
         ...
         <script>
            ...
            function generateQrCode() {
               ...
               $("#generatedCode").val(text); // Ensure jQuery is loaded
